...
int main()
{
  ...
  pf::Flock flock(80.0f, 10.0f, 0.7f, 0.06f, 0.0025f, 200.0f, 100.0f);
  pf::Vector pos1(0.0f, 300.0f);
  pf::Vector pos2(800.0f, 300.0f);
  pf::Vector pos3(275.0f, 0.0f);
  pf::Vector pos4(550.0f, 0.0f);
  pf::Vector pos5(275.0f, 600.0f);
  pf::Vector pos6(550.0f, 600.0f);
  pf::Vector vel1(100.0f, 0.0f);
  pf::Vector vel2(-100.0f, 0.0f);
  pf::Vector vel3(110.0f, 110.0f);
  pf::Vector vel4(-110.0f, 100.0f);
  pf::Vector vel5(120.0f, -100.0f);
  pf::Vector vel6(-85.0f, -100.0f);
